...
const EventDetails = async ({ params }: { params: Promise<string> }) => {
    ...
    const { description, image, overview, date, time, location, mode, audience, organizer } = event;

    if(!description) return notFound();

    const agenda = parseArrayField(event.agenda);
    const tags = parseArrayField(event.tags);
